  ...
  return (
    <div className="h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl">
      ...
      <div className="md:hidden lg:flex xl:w-1/3 xl:justify-center">
        ...
        >
          <span className="text-white">bohdan </span>
      ...
      {/* SOCIAL*/}
      <div className="hidden md:flex gap-4 w-1/3">
        <Link href="https://github.com/mishuta2014">
          <img src="/github.png" alt="" width={24} height={24} />
        </Link>
        <Link href="https://dribbble.com">
          <img src="/dribbble.png" alt="" width={24} height={24} />
        </Link>
        <Link href="https://www.instagram.com/bodya.goat">
          <img src="/instagram.png" alt="" width={24} height={24} />
        </Link>
        <Link href="https://www.facebook.com/profile.php?id=100048690651981">
          <img src="/facebook.png" alt="" width={24} height={24} />
        </Link>
        <Link href="https://www.linkedin.com/in/bohdan-kuliatov-45545a2b7/">
